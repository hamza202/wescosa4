<header class="page-header section">
    <!-- RD Navbar-->
    <div class="rd-navbar-wrap" style="height: 206px;">
                ...
                <div class="rd-navbar-main">
                    ...
                    <div class="rd-navbar-nav-wrap toggle-original-elements">
                        ...
                        <ul class="rd-navbar-nav">
                            ...
                            <li class="   rd-navbar--has-dropdown rd-navbar-submenu"><a href="aboutus.php">About Us</a><span class="rd-navbar-submenu-toggle"></span>
...
<!--                            <li class=""><a href="production.php">Production</a></li>-->
                            ...
                            <li class="  rd-navbar--has-dropdown rd-navbar-submenu"><a href="products.php">Products</a>
                                ...
                                <ul class="rd-navbar-dropdown rd-navbar-open-right">
                                    ...
                                    <li><a href="#">Low Voltage Equipment</a></li>
                                    <li><a href="#">Medium Voltage Equipment</a></li>
                                    <li><a href="#">High Voltage Equipment</a></li>
                                    <li><a href="#">servicesc alibration</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="  rd-navbar--has-dropdown rd-navbar-submenu"><a href="products.php">Vendors</a>
                                <span class="rd-navbar-submenu-toggle"></span>
                                <ul class="rd-navbar-dropdown rd-navbar-open-right">
                                    <li><a href="Tenders.php">Tenders</a></li>
                                    <li><a href="#">New Vendors</a></li>
                                    <li><a href="#">Current Vendors</a></li>
                                </ul>
                            </li>

                            <li><a href="career.php">Carrares</a></li>

                            <li ><a href="contact.php">contact us</a></li>
                            <li><a href="#" class="lang">العربية</a></li>
